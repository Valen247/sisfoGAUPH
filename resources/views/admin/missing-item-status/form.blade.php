<div class="form-group {{ $errors->has('item_code') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="item_code" type="number" id="item_code" value="{{ isset($missingitemstatus->item_code) ? $missingitemstatus->item_code : ''}}" >
    {!! $errors->first('item_code', '<p class="help-block">:message</p>') !!}
</div>
<div class="form-group {{ $errors->has('title') ? 'has-error' : ''}}">
    <label for="title" class="control-label">{{ 'Title' }}</label>
    <input class="form-control" name="title" type="text" id="title" value="{{ isset($missingitemstatus->title) ? $missingitemstatus->title : ''}}" >
    {!! $errors->first('title', '<p class="help-block">:message</p>') !!}
</div>
<div class="form-group {{ $errors->has('category_id') ? 'has-error' : ''}}">
    <label for="category_id" class="control-label">{{ 'Category Id' }}</label>
    <input class="form-control" name="category_id" type="number" id="category_id" value="{{ isset($missingitemstatus->category_id) ? $missingitemstatus->category_id : ''}}" >
...
<div class="form-group {{ $errors->has('description') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="description" type="text" id="description" value="{{ isset($missingitemstatus->description) ? $missingitemstatus->description : ''}}" >
...
<div class="form-group {{ $errors->has('missing_item_status') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="missing_item_status" type="number" id="missing_item_status" value="{{ isset($missingitemstatus->missing_item_status) ? $missingitemstatus->missing_item_status : ''}}" >
...
<div class="form-group {{ $errors->has('img_url') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="img_url" type="text" id="img_url" value="{{ isset($missingitemstatus->img_url) ? $missingitemstatus->img_url : ''}}" >
...
<div class="form-group {{ $errors->has('taken_at') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="taken_at" type="datetime-local" id="taken_at" value="{{ isset($missingitemstatus->taken_at) ? $missingitemstatus->taken_at : ''}}" >
...
<div class="form-group {{ $errors->has('taken_by') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="taken_by" type="number" id="taken_by" value="{{ isset($missingitemstatus->taken_by) ? $missingitemstatus->taken_by : ''}}" >
