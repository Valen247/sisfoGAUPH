...
@section('content')
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="card">
                    <div class="card-header">Replacementclass</div>
                    <div class="card-body">
                        <a href="{{ url('/admin/replacement-class/create') }}" class="btn btn-success btn-sm" title="Add New replacementClass">
                            ...
                            <table class="table">
                                ...
                                @foreach($replacementclass as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ url('/admin/replacement-class/' . $item->id) }}" title="View replacementClass"><button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i> View</button></a>
                                            <a href="{{ url('/admin/replacement-class/' . $item->id . '/edit') }}" title="Edit replacementClass"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
